...
def main():
    ...
    keys = list(annos)
    k_shot_classes = ["aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa"]
    ...
    bbb.generate('anno_pickle', base_anno, "../VOCdevkit/onedet_cache/two_class_base.pkl")
    pass
