...
def generate_aps(results_root="results"):
    ...
    class_names = ["train", "tvmonitor"] # ["aeroplane", "bicycle", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor"]
    recs = []
    precs = []
    aps = []
    tested_class = []
