...
class CustomDataset(vn_data.OneboxDataset):
...
def VocRgbmTest(hyper_params):
    ...
    net = models.__dict__[model_name](hyper_params.classes, weights,
                                      input_channels=4,train_flag=2, test_args=test_args)
    net.eval()
    ...
    dataset = CustomDataset(hyper_params)
