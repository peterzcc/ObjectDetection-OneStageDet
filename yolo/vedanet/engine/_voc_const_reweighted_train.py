...
from .. import models
from . import engine
__all__ = ['VocConstReweightedTrainingEngine']
...
class VocConstReweightedTrainingEngine(engine.Engine):
    ...
    def __init__(self, hyper_params):
        ...
        super(VocConstReweightedTrainingEngine, self).__init__(net, optim, dataloader)
